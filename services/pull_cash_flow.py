# services/pull_cash_flow.py
def fetch_cash_flow_data(service, core_sheet_id, child_id):
    try:
        result = service.spreadsheets().values().get(spreadsheetId=core_sheet_id, range='Cash-Flow!G4:N').execute()
